...
public class JugadorEmpateVista {
    protected Node nodo;
    public JugadorEmpateVista(Jugador jugador) {
        this.cargarEstilo(jugador.nombre(),jugador.puntajeTotal());
    }

    private void cargarEstilo(String nombre, Punto puntaje) {
        ...
        Label jLabelPuntos = new Label(puntaje.obtenerValor().toString());
